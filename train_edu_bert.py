...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--base_model_name", type=str, default="ckiplab/bert-base-chinese"
    )
    parser.add_argument(
        "--dataset_name",
        type=str,
    ...
    parser.add_argument(
        "--checkpoint_dir",
        type=str,
        default="/fsx/anton/cosmopedia/edu_score/bert-base-chinese",
    )
    parser.add_argument(
        "--output_model_name", type=str, default="HuggingFaceTB/fineweb-edu-scorer-zhtw"
    )
